...
#Appeler quand le quest manager detecte une récompence
func _on_quete_manager_recompence(drop) -> void:
	var i = 0 
...
func _on_scarabée_scaranbee_ramasse() -> void:
	#add_tres_inventaire("res://RPG-test/items/Bug.tres",1)
